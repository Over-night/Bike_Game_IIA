...
public class PoseEstimator : MonoBehaviour
{
    ...
    private void InitializeVideoScreen(int width, int height, bool mirrorScreen)
    {
        ...
        videoScreen.localScale = new Vector3(14, 9, -1);
        // Adjust the VideoScreen position for the new videoTexturew
        videoScreen.position = new Vector3(4.7f, 11.3f, 100f);
    }
    ...
    private void InitializeCamera()
    {
        ...
        GameObject mainCamera = GameObject.Find("TPP_Camera");
    ...
    void Update()
    {
        ...
        actType = skeletons[0].GetMotionType();
    }
